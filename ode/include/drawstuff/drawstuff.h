 ...
 * @param blue Blue component from 0 to 1
 */
DS_API void dsSetBackGround (float red, float green, float blue);
DS_API void dsSetLight (float x, float y);

DS_API void dsSetDrawSky (bool draw);

DS_API void dsSetDrawGround (bool draw);
DS_API void dsSetDrawShadow (bool draw);
/**
