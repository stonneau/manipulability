...
static float background[3] = {1,1,1};	// current r,g,b,alpha color
static bool drawSky_ = false;	// current r,g,b,alpha color
static bool drawGround_ = false;	// current r,g,b,alpha color
...
static void drawSky (float view_xyz[3])
{
  ...
  dsSetColor(1., 0.78, 0.05);
  GLfloat fogColor[4] = {0.5, 0.5, 0.5, 1};
  //GLfloat fogColor[4] = {1., 0.78, 0.05, 1};
  glEnable (GL_FOG);
...
extern "C" void dsSetBackGround (float red, float green, float blue)
{
  background[0] = red;
  background[1] = green;
  background[2] = blue;
...
extern "C" void dsSetDrawSky (bool draw)
{
  drawSky_ = draw;
}

extern "C" void dsSetDrawGround (bool draw)
{
	drawGround_ = draw;
}

extern "C" void dsSetDrawShadow (bool draw)
{
	use_shadows = draw ? 1 : 0;
}


extern "C" void  dsSetLight (float x, float y)
{
	LIGHTX = x;
	LIGHTY = y;
}
